    ...
    internal class Killsteal
    {
        public static void Execute()
        {
            if (Config.KillstealQ)
            {
                ...
                if (enemy == null || !enemy.IsValidTarget(Spells.Q.Range)) return;
                Spells.CastQ(enemy);
            }
            ...
            if (Config.KillstealW)
            {
                ...
                if (enemy == null || !enemy.IsValidTarget(Spells.W.Range)) return;
                Spells.CastW(enemy);
            }
            ...
            if (Config.KillstealR)
            {
                ...
                if (enemy == null || !enemy.IsValidTarget(Spells.R.Range)) return;
                Spells.R.CastMinimumHitchance(enemy, Spells.HitChanceChooser());
            }
        }
    }
}